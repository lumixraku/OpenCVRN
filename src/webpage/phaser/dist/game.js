(function (phaser) {
  ...
  var stageHeight = document.body.clientWidth / 9 * 18;
  ...
  ***************************************************************************** */
  ...
  var SpinTable = /** @class */ (function () {
      function SpinTable(scene, spinSpeed) {
          ...
          this.platePosRadius = this.circleRadius;
      ...
      SpinTable.prototype.createTable = function () {
          ...
          var bds = this.spinTableSprite.getBounds();
          var width = bds.width;
      ...
      SpinTable.prototype.addPlates = function () {
          for (var i = 0; i < this.tableCapacity; i++) {
              ...
              var plate = this.scene.add.image(p.x, p.y, 'plate');
              plate.setScale(0.6);
              this.plates[i] = plate;
  ...
  var Cook = /** @class */ (function (_super) {
      ...
      function Cook(scene, x, y) {
          var _this = _super.call(this, scene, x, y, 'cookbody', 0) || this;
          ...
          scene.add.existing(_this); // add existing 是推荐做法
  ...
  var bgImgWidth = 750;
  var hollowCenter = new Point$5(300, 300);
  var Demo = /** @class */ (function (_super) {
      ...
      Demo.prototype.drawHollowBackground = function () {
          ...
          var hollowCenter = new Point$5(300, 450);
          var faceRadius = 50;
      ...
      Demo.prototype.addYourself = function () {
  ...
  var GameUIScene = /** @class */ (function (_super) {
      ...
      GameUIScene.prototype.createCaughtText = function (x, y, cb) {
          ...
          var containerWidth = 400;
          var containerHeight = 100;
          var containerPos = new Point$6(stageWidth / 2, stageHeight / 2 * 1.6);
  ...
  var EffectScene = /** @class */ (function (_super) {
      ...
      EffectScene.prototype.update = function () {
          var _loop_1 = function (idx) {
              ...
              if (dropCoin && Math.abs(dropCoin.y + coinSize$2 - stageHeight) < 15) {
      ...
      EffectScene.prototype.addCoin = function (addScoreCount) {
          var _this = this;
          var coin = this.add.image(stageWidth / 2, stageHeight / 2, 'coin');
          // this.coin.displayWidth = 64
          // this.coin.displayHeight = 64
          // scale 是根据原图的大小而言的。
      ...
      EffectScene.prototype.createScoreArea = function () {
          var scoreAreaCenter = new Point$7(stageWidth / 2 + 100, 50);
